...
class SubMenuController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/web/setting_web/submenu/list",
     *     tags={"SubMenu"},
    ...
    /**
     * @OA\Get(
     *     path="/web/setting_web/submenu/{uuid}",
     *     tags={"SubMenu"},
    ...
    /**
     * @OA\Get(
     *     path="/web/setting_web/submenu/generate-code",
     *     tags={"SubMenu"},
    ...
    /**
     * @OA\Post(
     *     path="/web/setting_web/submenu/add",
     *     tags={"SubMenu"},
    ...
    /**
     * @OA\Get(
     *     path="/web/setting_web/submenu/global_search",
     *     tags={"SubMenu"},
