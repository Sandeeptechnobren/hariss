    ...
    public function collection()
    {
        ...
        foreach ($this->data as $item) {
            $rows[] = [
                ...
                'Item Name'       => (string) $item->item_name,
                'Item Code'       => (string) $item->item_code,
                'ERP Code'        => (string) $item->erp_code,
                'Available Qty'   => (float) $item->available_stock_qty,
                'Total Sales'     => (float) $item->total_sales,
                'Purchase Qty'    => (float) $item->purchase_qty,
                'Avg Per Day'     => (float) $item->avg_per_day,
                'Required Qty'    => (float) $item->required_qty,
                'Health Flag'     => (int) $item->health_flag,
            ];
        }
