 ...
 */
  ...
  /**
 * @OA\Get(
 *     path="/mob/merchendisher_mob/planogram-post/list",
 *     summary="Get list of Planogram Posts (with filters and pagination)",
 *     tags={"PlanogramPosts"},
 *     security={{"bearerAuth":{}}},
 *     operationId="getPlanogramPosts",
 *
 *     @OA\Parameter(
 *         name="merchendisher_id",
 *         in="query",
 *         required=false,
 *         description="Filter by merchendisher ID",
 ...
 */
    ...
    {
        $filters = $request->only(['merchendisher_id', 'planogram_id', 'shelf_id', 'customer_id']);
        $perPage = $request->get('per_page', 10);

        $planogramPosts = $this->service->list($filters, $perPage);
