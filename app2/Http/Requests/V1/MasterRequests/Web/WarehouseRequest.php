...
class WarehouseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'warehouse_type'=>'required|string|in:company_outlet,agent_customer',
            'warehouse_name' => 'required|string|min:3|max:50',
            'owner_name' => 'required|string|max:50',
            'owner_number' => 'required|numeric|digits_between:1,15',
...
<<<<<<< HEAD
            'tin_no' => 'required|string|max:30',
            'registation_no' => 'required|string|max:30',
            'business_type' => 'required|in:0,1',
...
>>>>>>> origin/adarsh
            ...
            'area_id' => 'required|exists:tbl_areas,id',
            'latitude' => [
                'required',
                'string',
                'max:50',
