...
/**
 * @OA\Get(
 *     path="/api/merchendisher/shelves/exportfile",
 ...
 public function export(Request $request)
{
    ...
    $data = $this->service->getFilteredShelves($filters);

    $fileName = 'shelves_export_' . now()->format('Y_m_d_H_i_s') . ($request->format === 'csv' ? '.csv' : '.xlsx');

    return Excel::download(
        new ShelveExport($data),
        $fileName,
