...
<table style="width:100%; border-collapse:collapse; margin-top:8px; line-height:1.6;">
    ...
    <tr>
        <td style="padding-top:6px;">
            Signature:
            <span style="display:inline-block; border-bottom:1px dotted #000; width:75%;"></span>
        </td>
        <td style="padding-top:6px;">
            Signature:
            <span style="display:inline-block; border-bottom:1px dotted #000; width:75%;"></span>
...
<table style="width:100%; border-collapse:collapse; margin-top:10px; line-height:1.6;">
    ...
    <tr>
        ...
        <td style="width:30%;">
            Signature:
            <span style="border-bottom:1px dotted #000; display:inline-block; width:70%;"></span>
        </td>
    </tr>
    ...
    <tr>
        <td>
            2. LC Officer/Agent:
            <span style="border-bottom:1px dotted #000; display:inline-block; width:60%;"></span>
        </td>
        <td>
            Name & Contact No:
            <span style="border-bottom:1px dotted #000; display:inline-block; width:70%;"></span>
