...
<head>
    <meta charset="UTF-8">
    <title>DELIVERY #{{ $delivery->delivery_code }}</title>
</head>
...
<body style="font-family: Arial, Helvetica, sans-serif; font-size:14px;">
    ...
    <table width="100%" cellpadding="2" cellspacing="0"
        ...
        <tr>
            <td style="border:1px solid #000; width:30%;">Delivery Date:</td>
            <td style="border:1px solid #000;">
        ...
        <tr>
            <td style="border:1px solid #000;">Address:</td>
            <td style="border:1px solid #000;">
                {{ $delivery->customer->street ?? '' }}
                {{ $delivery->customer->town ?? '' }}
                {{ $delivery->customer->landmark ?? '' }}
                {{ $delivery->customer->district ?? '' }}
            </td>
        </tr>
        <tr>
            <td style="border:1px solid #000;">Telephone:</td>
            <td style="border:1px solid #000;">
                {{ $delivery->customer->contact_no ?? '' }}
            </td>
        </tr>
    </table>
    ...
    <span style="font-weight:bolder;">
        Delivery Value is Inclusive of VAT
    </span>
    ...
    <table width="100%" cellpadding="2" cellspacing="0">
        <tr>
            <td colspan="2" style="text-align:center; font-size:12px;">
                <span style="font-weight:bolder;">
                    This is a system generated delivery note and doesn't require any signature
                    <br><br>
                </span>
