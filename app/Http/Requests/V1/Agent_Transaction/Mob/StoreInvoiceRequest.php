...
class StoreInvoiceRequest extends FormRequest
{
    public function rules(): array
    {
         return [
            ...
            'promotion_id' => 'nullable|integer|exists:tbl_promotion_headers,id',
            ...
            'ura_antifake_code' => 'nullable|string',
            'ura_invoice_no' => 'nullable|string',
            ...
            'details.*.itemvalue' => 'nullable|numeric|min:0',
