...
class CustomerLoyalityActivity extends Model
{
    use HasFactory,SoftDeletes, Blames;
    protected $table = 'customerloyality_activity';
...
{
    return $this->belongsTo(CustomerLoyalityPoint::class, 'header_id','id');
}
...
public function invoices()
{
    ...
    if (!is_array($ids)) {
        return InvoiceHeader::where('id', $ids)->get();
    }

    return InvoiceHeader::whereIn('id', $ids)->get();
}
}