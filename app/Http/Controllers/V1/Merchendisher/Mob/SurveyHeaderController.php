...
/**
 * @OA\Get(
 *     path="/api/merchendisher/survey-header/show/{uuid}",
 *     tags={"Survey Headers"},
 ...
 *         name="uuid",
 *         in="path",
 *         description="UUID of the survey header to retrieve",
 *         required=true,
 ...
 * )
 */
public function show(string $surveyUuid): JsonResponse
    {
        $header = $this->service->getBySurveyUuid($surveyUuid);
        return $this->success(
        SurveyHeaderResource::collection($header)
        );
    }
