...
use App\Services\V1\B2C_App\Master\DataStoragePathService;
use Illuminate\Http\Request;
use Exception;

class DataStoragePathController extends Controller
{
    protected $settingService;

    public function __construct(DataStoragePathService $settingService)
    {
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = $this->settingService->saveAllData($username);
